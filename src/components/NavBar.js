...
const NavBar = () => {
    ...
    return (
        <Navbar expand="lg" className={scrolled ? "scrolled" : ""} expanded={expanded}>
            <Container>
            <Navbar.Brand href="#home" className="brand" onClick={() => updateActiveLink('home')}>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <span className="navbar-text">
                        <div className="social-icon">
                            <a href="https://www.linkedin.com/in/vatsal-shah-a7a0b1255/" target="_blank" rel="noreferrer">
                                <img src={navIcon1} alt="LinkedIn" />
                            </a>
                            <a href="https://www.instagram.com/vatsal.14/?hl=en" target="_blank" rel="noreferrer">
                                <img src={navIcon3} alt="Instagram" />
                            </a>
                            <a href="https://github.com/Vatsal2006350" target="_blank" rel="noreferrer">
